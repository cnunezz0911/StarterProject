...
var Posters = function (_React$Component) {
    ...
    _createClass(Posters, [{
        ...
        value: function handleItem(id) {
            debugger;
            // const urlParams = new URLSearchParams(location.search(id));
            var nameYouWant = __WEBPACK_IMPORTED_MODULE_4_query_string___default.a.parse(this.props.location.search).nameYouWant;
...
//# sourceMappingURL=0.78e60aae7d3f0371311c.hot-update.js.map