...
var Posters = function (_React$Component) {
    ...
    function Posters(props) {
        ...
        _this.selectedItem = function (i) {
            var data = _this.state.movies;
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get("http://localhost.65332/api/poster/" + data).then(function (resp) {
                console.log(id, data);
            });
        };
...
//# sourceMappingURL=0.766a821a6fd58c62a151.hot-update.js.map